                    ...
                    <div className="flex justify-around items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-1 text-zinc-400">
                                {
                                    Math.floor(
                                       ((data?.totalTransactions || 0) + ((data?.totalTransactions || 0) * 50) / 100)
                                )
                                }
                            </p>
                        </div>
                    ...
                    <div className="flex justify-around items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-1 text-zinc-400">
                                {
                                    Math.floor(
                                       ((data?.totalCredit || 0) + ((data?.totalCredit || 0) * 50) / 100)
                                )
                                }
                            </p>
                        </div>
                    ...
                    <div className="flex justify-around items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-1 text-zinc-400">
                                {
                                    Math.floor(
                                       ((data?.totalDebit || 0) + ((data?.totalDebit || 0) * 50) / 100)
                                )
                                }
                            </p>
                        </div>
                    ...
                    <div className="flex justify-around items-center">
                        ...
                        <div>
                            ...
                            <p className="text-lg mt-1 text-zinc-400">
                                {
                                    Math.floor(
                                       ((data?.balance || 0) + ((data?.balance || 0) * 50) / 100)
                                )
                                }
                            </p>
                        </div>
